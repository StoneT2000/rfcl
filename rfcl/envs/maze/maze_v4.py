"""
Adapted from Gymnasium-Robotics

Allows adding collision enabled walls (value of 2, not 1)/
    ...
    def make_maze(
        ...
        for i in range(maze.map_length):
            for j in range(maze.map_width):
                ...
                if struct == 1 or struct == 2:  # Unmovable block.
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            # small fix to ensure if we are doing a lot of parallelization this doesn't keep being missing.
